...
public:
    ...
    void SetTailTimeRange(int trange);
    void SetMaxWindow(int size);
    void SetNic(int num);
...
private:
    ...
    static void main_receive_packet_loop(DMAcontext* dma_context, int32_t* data, int my_id, CC_manager& cc_manager);
